 ...
 */
'use strict';
const Api = require('../../Bhsd-bot-public/lib/api.js'),
	QQ = require('../../Bhsd-bot-public/lib/qq.js'),
	{error, trim, decodeHtml, sleep, isObject} = require('./dev.js'),
	...
	nsPrefix = new RegExp(`^${[
		...
		'talk', '对话', '對話', '讨论', '討論',
		'user', '用户', '用戶', '使用者',
		'user_talk', '用户对话', '用戶對話', '用户讨论', '用戶討論', '使用者討論',
		'llwiki', 'project',
		'llwiki_talk', 'project_talk', 'llwiki讨论', 'llwiki討論',
		'file', 'image', '图像', '圖像', '档案', '檔案', '文件', '媒体文件',
		...
		'help', '帮助', '幫助', '使用說明',
		'help_talk', '帮助对话', '幫助對話', '帮助讨论', '幫助討論', '使用說明討論',
		'category', '分类', '分類',
		'category_talk', '分类对话', '分類對話', '分类讨论', '分類討論',
		'widget',
		'widget_talk',
		'module', '模块', '模組',
		'module_talk', '模块讨论', '模組討論',
	].join('|')}`, 'i');
